...
Set-AzResource -Properties $PropertiesObject -ResourceGroupName $rgName -ResourceType Microsoft.Web/sites/sourcecontrols -ResourceName $nameOfWebService/Web -ApiVersion 2015-08-01 -Force